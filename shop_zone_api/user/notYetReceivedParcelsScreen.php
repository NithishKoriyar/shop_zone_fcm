...
$stmt = $connectNow->prepare("SELECT orderId, addressID, orderTime, itemQuantity, totalAmount, itemID, orderStatus FROM users_orders WHERE orderBy = ? AND orderStatus = 'shifted'");
