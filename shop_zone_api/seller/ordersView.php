...
$sql = "SELECT orderId,orderBy, addressID, orderTime, itemQuantity, totalAmount, itemID, orderStatus FROM users_orders WHERE  orderStatus = 'normal' AND sellerUID = '$sellerID'";
